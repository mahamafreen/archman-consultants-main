...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      <a
        href="https://wa.me/923003509148?text=Hi%20Archman%20Consultants%2C%20I%27d%20like%20to%20get%20in%20touch."
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Reach us on WhatsApp"
        className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#da0101] text-white shadow-lg transition-transform hover:scale-110 hover:shadow-xl"
      >
